...
=================
- [Decision Making with Programming and Analytics Project](#decision-making-with-programming-and-analytics-project)
- [Table of Contents :bookmark\_tabs:](#table-of-contents-bookmark_tabs)
  - [Project Statement](#project-statement)
    - [He has brought with him 2 items for your analysis:](#he-has-brought-with-him-2-items-for-your-analysis)
  - [Approach](#approach)
    - [Problem Understanding](#problem-understanding)
    - [Data Format](#data-format)
    - [Data Cleaning/Preprocessing](#data-cleaningpreprocessing)
      - [Interesting Findings from Data Cleaning](#interesting-findings-from-data-cleaning)
...
### He has brought with him 2 items for your analysis: 
 ...
 (2) The second file (stockcards.csv) contains transactional records with more than 56000 lines of data covers the period from Jan 2011 to Apr 2019. The header information and first 10 records are shown below:
